    ...
    >
      ...
      <Grid templateColumns="repeat(4, 1fr)" gap={10} my="50px">
        <Box maxW={"300px"} color={"#000"}>
          ...
          <Text>
          Add your logo and customize UI colors to match your brand.
          </Text>
        </Box>
        <Box maxW={"300px"} color={"#000"}>
          <Image src={u2} h={"50px"} />
          ...
          <Text>
          Deliver a seamless charging experience with a QR scan. 
          </Text>
        </Box>
        <Box maxW={"300px"} color={"#000"}>
          <Image src={u3} h={"50px"} />
          ...
          <CustomButton btnText={"Get the ChargeLab app"} color={"blue.300"} bg={"none"} px={"0px"}/>
        </Box>
        <Box maxW={"300px"} color={"#000"}>
          <Image src={u4} h={"50px"} />
          <Text py="10px" fontSize={"18px"} fontWeight={"bold"}>
