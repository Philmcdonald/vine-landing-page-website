...
const ChargeLab = () => {
  return (
    <Box bg={'#fff'} justifyContent={'center'} h={'fit-content'}>
      <Wrapper>
        <Box>
          <SubHeading maxW={'500px'} margin={'0px auto'} textAlign={'center'}>
            Partnering with Vine Mobility has never been easier
          </SubHeading>
          <Grid
          ...
          <Flex justify={'center'} mt="100px" mb="30px" align={'center'}>
            ...
            >
              <Box
                ...
                maxW={'600px'}
              >
                <InfoHeading color={'#fff'}>Limited time offer</InfoHeading>
                <SubHeading py="20px">
                  Earn $1,000+ in bonuses as a ChargeLab reseller.
                </SubHeading>
                <CustomText>
                  We cut you a check for $500 when you deploy two ports. Refer
                  your friends to this program and get $500 for each one that
                  deploys 2 or more ports.
                </CustomText>
                <Box mt="20px">
                  <CustomButton
                    btnText={'Get started'}
          ...
          <Text textAlign={'center'} fontWeight={'medium'}>
            ...
            <span style={{ color: 'teal', fontWeight: 'bold' }}>See here </span>
            for details.
          </Text>
        </Box>
      </Wrapper>
