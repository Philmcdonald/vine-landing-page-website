      ...
      <Flex mt="70px" justify={"space-between"}>
        <Box maxW={"600px"}>
          ...
          <Text fontWeight={"medium"} fontSize={"20px"} py="30px">
            Thousands of electric vehicle drivers rely on workplace EV chargers
            to stay fully charged. Join the EV revolution by offering workplace
            charging at your office building.
          </Text>
